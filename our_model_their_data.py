...
DATA_DIR = Path("IR_optical_demo/data")
REG0_CSV = DATA_DIR / "sdss_wise_cross_reg0.csv"
REG1_CSV = DATA_DIR / "sdss_wise_cross_reg1.csv"

OUT_DIR = Path("our_model_their_data")
